...
class Forecaster:
    ...
    def fit(self, data, group_size):
        ...
        training = TimeSeriesDataSet(
            ...
            target= 'next_week_fantasy_points',  # column name of target to predict
            ...
            time_varying_known_reals=[ 'passingYards', 'passingTouchdowns', 'interceptions', 'rushingYards',
                                    'rushingTouchdowns', 'completions', 'passingAttempts', 'fumblesLost' ],
            time_varying_unknown_categoricals=[  ],
            time_varying_unknown_reals=[ 'next_week_fantasy_points' ],
        )
...
if __name__ == "__main__":
    ...
    for group_size in sizes:
        ...
        df = df[['player_name', 'time_idx', 'passingYards', 'passingTouchdowns', 'interceptions', 'rushingYards', 
                'rushingTouchdowns', 'completions', 'passingAttempts', 'fumblesLost', 'next_week_fantasy_points']]
